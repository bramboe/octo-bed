...
Control your Octo adjustable bed from Home Assistant via Bluetooth (ESPHome proxy supported).
...
- 4-digit PIN authentication with keep-alive and automatic reconnect (two beds on one proxy supported)
